...
const PROJECTS = [
  ...
  {
    title: "Warehouse Post-Shutdown Deep Clean",
    client: "Logistics operator",
    sector: "Warehousing",
    scope:
      "Full industrial clean of a warehouse and machine hall during a planned shutdown, including high-level cleaning and floor restoration.",
  ...
  {
    title: "Water Treatment & Sanitation Upgrade",
    client: "Food processing facility",
    sector: "Food Processing",
    scope:
      "Installed and commissioned treatment and sanitation infrastructure, with documentation prepared for regulatory inspection.",
    duration: "12 months",
    crew: "9 technicians",
    outcome: "Passed every inspection since",
    image: building,
    video: "",
    gallery: 0,
  },
